...
$stok = (isset($_POST['stok'])) ? htmlentities($_POST['stok']) : 0;
    ...
    if(!empty($_POST['input_menu_validate'])){
        ...
        if($cek === false){
            $message = "Mohon masukan file gambar";
            $statusUpload = 0;
        }else{
            $statusUpload = 1;
            if(file_exists($target_file)){
                ...
                if($_FILES['foto']['size'] > 500000){
                    ...
                    if($imageType != "jpg" && $imageType != "png" && $imageType != "jpeg"){
                        $message = "Maaf, hanya diperbolehkan gambar yang memiliki formar jpg,png dan jpeg";
                        $statusUpload = 0;
                    }
                }
            }
